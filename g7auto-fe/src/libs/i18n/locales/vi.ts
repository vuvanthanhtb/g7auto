export const vi: Record<string, string> = {
  ...
  ACCOUNTS_FIELD_USERNAME: "Tên đăng nhập",
  ACCOUNTS_FIELD_FULL_NAME: "Họ và tên",
  ACCOUNTS_FIELD_EMAIL: "Email",
  ACCOUNTS_FIELD_ROLES: "Vai trò",
  ACCOUNTS_FIELD_STATUS: "Trạng thái",
  ...
  CARS_FIELD_SALE_PRICE: "Giá bán thực tế",
  CARS_FIELD_STATUS: "Trạng thái xe",
  CARS_FIELD_ARRIVAL_DATE: "Ngày nhập kho",
  CARS_FIELD_YEAR: "Năm sản xuất",
  ...
  CUSTOMERS_FIELD_FULL_NAME: "Họ tên khách hàng",
  ...
  EMPLOYEES_FIELD_CODE: "Mã nhân viên",
  EMPLOYEES_FIELD_FULL_NAME: "Họ và tên",
  EMPLOYEES_FIELD_PHONE: "Điện thoại",
  EMPLOYEES_FIELD_EMAIL: "Email cá nhân",
  EMPLOYEES_FIELD_ADDRESS: "Địa chỉ thường trú",
  EMPLOYEES_FIELD_GENDER: "Giới tính",
  EMPLOYEES_FIELD_BIRTH_DATE: "Ngày sinh",
  EMPLOYEES_FIELD_START_DATE: "Ngày vào làm",
  EMPLOYEES_FIELD_STATUS: "Trạng thái",
  EMPLOYEES_FIELD_SHOWROOM: "Showroom làm việc",
  EMPLOYEES_FIELD_USERNAME: "Tài khoản hệ thống",
  EMPLOYEES_TAB_LIST: "Danh sách nhân viên",
  EMPLOYEES_FIELD_ID: "ID nhân viên",
  ...
  CONTRACTS_FIELD_SALE_PRICE: "Giá bán thực tế",
  CONTRACTS_FIELD_DEPOSIT_AMOUNT: "Số tiền đã cọc",
  ...
  CONTRACTS_FIELD_NOTES: "Ghi chú hợp đồng",
  ...
  CONTRACTS_FIELD_STATUS: "Trạng thái hợp đồng",

  // === QUOTATIONS ===
  QUOTATIONS_PAGE_HEADER: "Quản lý Báo giá",
  QUOTATIONS_BTN_CREATE: "Tạo báo giá",
  QUOTATIONS_DRAWER_DETAIL: "Chi tiết báo giá",
  QUOTATIONS_FIELD_CUSTOMER: "Khách hàng",
  QUOTATIONS_FIELD_CAR: "Xe báo giá",
  QUOTATIONS_FIELD_EMPLOYEE: "Nhân viên lập",
  QUOTATIONS_FIELD_QUOTED_PRICE: "Giá báo",
  QUOTATIONS_FIELD_VALID_DATE: "Ngày hết hạn báo giá",
  QUOTATIONS_FIELD_TOTAL_AMOUNT: "Tổng giá trị dự toán",
  QUOTATIONS_FIELD_CAR_PRICE: "Giá xe",
  QUOTATIONS_FIELD_ACCESSORIES: "Tiền phụ kiện",
  QUOTATIONS_FIELD_PROMOTION: "Khuyến mãi",
  QUOTATIONS_FIELD_OTHER_COSTS: "Chi phí khác",
  QUOTATIONS_BTN_SEND: "Gửi báo giá",
  QUOTATIONS_BTN_ACCEPT: "Chấp nhận",
  QUOTATIONS_BTN_CANCEL: "Hủy báo giá",
  QUOTATIONS_FIELD_STATUS: "Trạng thái báo giá",

  // === DEPOSITS ===
  DEPOSITS_PAGE_HEADER: "Quản lý Đặt cọc",
  DEPOSITS_BTN_CREATE: "Tạo đặt cọc",
  DEPOSITS_DRAWER_DETAIL: "Chi tiết đặt cọc",
  DEPOSITS_FIELD_CUSTOMER: "Khách hàng",
  DEPOSITS_FIELD_CAR: "Xe đặt giữ",
  DEPOSITS_FIELD_EMPLOYEE: "Nhân viên thu cọc",
  DEPOSITS_FIELD_AMOUNT: "Số tiền đặt cọc",
  DEPOSITS_FIELD_DATE: "Ngày đặt cọc",
  DEPOSITS_FIELD_EXPIRED_DATE: "Ngày hết hạn giữ xe",
  ...
  DEPOSITS_FIELD_STATUS: "Trạng thái phiếu cọc",
  ...
  PAYMENTS_FIELD_AMOUNT: "Số tiền thanh toán",
  PAYMENTS_FIELD_METHOD: "Phương thức TT",
  PAYMENTS_FIELD_TIME: "Thời gian thanh toán",
  PAYMENTS_FIELD_INSTALLMENT: "Đợt thanh toán",
  PAYMENTS_FIELD_COLLECTOR_ID: "ID Thu ngân",
  ...
  PAYMENTS_FIELD_STATUS: "Trạng thái thanh toán",
  ...
  TRANSFERS_BTN_CREATE: "Tạo phiếu điều chuyển",
  TRANSFERS_DRAWER_DETAIL: "Chi tiết điều chuyển",
  TRANSFERS_DRAWER_CREATE: "Tạo phiếu điều chuyển",
  TRANSFERS_FIELD_CAR: "Xe điều chuyển",
  TRANSFERS_FIELD_FROM_SHOWROOM: "Showroom xuất",
  TRANSFERS_FIELD_TO_SHOWROOM: "Showroom nhập",
  ...
  TRANSFERS_FIELD_NOTES: "Ghi chú vận chuyển",
  ...
  TRANSFERS_FIELD_STATUS: "Trạng thái lệnh",
  ...
  TEST_DRIVES_FIELD_CUSTOMER: "Khách hàng",
  TEST_DRIVES_FIELD_CAR: "Xe demo",
  TEST_DRIVES_FIELD_EMPLOYEE: "Sale hỗ trợ",
  TEST_DRIVES_FIELD_SHOWROOM: "Showroom lái thử",
  ...
  TEST_DRIVES_BTN_COMPLETE: "Hoàn thành lái thử",
  TEST_DRIVES_BTN_CANCEL: "Hủy lịch",
  TEST_DRIVES_FIELD_STATUS: "Trạng thái lịch",
  TEST_DRIVES_FIELD_NOTES: "Nhận xét của khách",
  ...
  CAR_MODELS_FIELD_SERIES: "Dòng xe",
  CAR_MODELS_FIELD_YEAR: "Năm sản xuất",
  CAR_MODELS_FIELD_COLOR: "Màu sắc",
  CAR_MODELS_FIELD_CAR_TYPE: "Loại xe",
  CAR_MODELS_FIELD_ENGINE: "Động cơ",
  CAR_MODELS_FIELD_TRANSMISSION: "Hộp số",
  CAR_MODELS_FIELD_LISTED_PRICE: "Giá niêm yết",
  CAR_MODELS_FIELD_DESCRIPTION: "Mô tả chi tiết",
  CAR_MODELS_FIELD_STATUS: "Trạng thái kinh doanh",
  ...
  SHOWROOMS_FIELD_ADDRESS: "Địa chỉ",
  SHOWROOMS_FIELD_PHONE: "Số điện thoại",
  SHOWROOMS_FIELD_EMAIL: "Email liên hệ",
  SHOWROOMS_FIELD_MANAGER: "Người quản lý",
  SHOWROOMS_FIELD_STATUS: "Trạng thái hoạt động",
  ...
  VALIDATION_MIN_3_CHAR: "Tối thiểu 3 ký tự",
  VALIDATION_INVALID_EMAIL: "Email không hợp lệ",
  VALIDATION_REQUIRED_USERNAME: "Tên đăng nhập là bắt buộc",
  VALIDATION_REQUIRED_PASSWORD: "Mật khẩu là bắt buộc",
  VALIDATION_REQUIRED_CAR_MODEL: "Dòng xe là bắt buộc",
  VALIDATION_REQUIRED_SHOWROOM: "Showroom là bắt buộc",
  VALIDATION_REQUIRED_CAR: "Xe là bắt buộc",
  VALIDATION_REQUIRED_CUSTOMER: "Khách hàng là bắt buộc",
  VALIDATION_REQUIRED_REASON: "Lý do điều chuyển là bắt buộc",
  VALIDATION_REQUIRED_SIGN_DATE: "Ngày ký là bắt buộc",
  VALIDATION_REQUIRED_CONTRACT_VALUE: "Giá trị hợp đồng là bắt buộc",
  VALIDATION_REQUIRED_DEPOSIT_AMOUNT: "Số tiền cọc là bắt buộc",
  VALIDATION_REQUIRED_PAYMENT_METHOD: "Phương thức thanh toán là bắt buộc",
  VALIDATION_REQUIRED_AMOUNT: "Số tiền là bắt buộc",
  VALIDATION_REQUIRED_CONTACT_TYPE: "Loại liên hệ là bắt buộc",
  VALIDATION_REQUIRED_SERVICE_DATE: "Ngày thực hiện là bắt buộc",
  VALIDATION_REQUIRED_START_TIME: "Thời gian bắt đầu là bắt buộc",
  VALIDATION_REQUIRED_END_TIME: "Thời gian kết thúc là bắt buộc",
  VALIDATION_REQUIRED_CHASSIS_NUMBER: "Số khung xe là bắt buộc",
  VALIDATION_REQUIRED_ENGINE_NUMBER: "Số máy là bắt buộc",
  VALIDATION_REQUIRED_FROM_SHOWROOM: "Showroom nguồn là bắt buộc",
  VALIDATION_REQUIRED_TO_SHOWROOM: "Showroom đích là bắt buộc",
  VALIDATION_REQUIRED_ROLE: "Vai trò là bắt buộc",
  VALIDATION_REQUIRED_ADDRESS: "Địa chỉ là bắt buộc",
  VALIDATION_REQUIRED_FULL_NAME: "Họ tên là bắt buộc",
  VALIDATION_REQUIRED_PHONE: "Số điện thoại là bắt buộc",
  VALIDATION_REQUIRED_MANUFACTURER: "Hãng sản xuất là bắt buộc",
  VALIDATION_REQUIRED_NATIONAL_ID: "CMND/CCCD là bắt buộc",
  VALIDATION_REQUIRED_CONTRACT: "Hợp đồng là bắt buộc",
