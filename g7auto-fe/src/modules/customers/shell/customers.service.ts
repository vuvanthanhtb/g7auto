...
import type { CustomerRequest, CustomerResponse, CustomerQuery, CustomerExportPayload } from "./customers.type";
...
class CustomersRepository {
  ...
  getAll() { return http.call<CustomerResponse[]>({ url: CUSTOMERS_ENDPOINT.LIST, method: "GET" }); }
  ...
  delete(id: number) { return http.call<void>({ url: `${CUSTOMERS_ENDPOINT.BASE}/${id}`, method: "DELETE" }); }
  ...
  export(params?: CustomerExportPayload) { return http.download({ url: `${CUSTOMERS_ENDPOINT.BASE}/export`, params, filename: "danh-sach-khach-hang.xlsx" }); }
}
