...
interface ICustomersRepository {
  getList(params?: CustomerPayload): AR<CustomerPage>;
  ...
  export(params?: CustomerExportPayload): Promise<Blob>;
}
...
class CustomersRepository implements ICustomersRepository {
  ...
  getList(params?: CustomerPayload): AR<CustomerPage> {
    return http.call<CustomerPage>({ url: BASE, method: "GET", params });
  }
  getById(id: number): AR<CustomerResponse> {
    return http.call<CustomerResponse>({ url: `${BASE}/${id}`, method: "GET" });
  }
  create(data: CustomerRequest): AR<CustomerResponse> {
    return http.call<CustomerResponse>({ url: BASE, method: "POST", data });
  }
  update(id: number, data: CustomerRequest): AR<CustomerResponse> {
    return http.call<CustomerResponse>({
      url: `${BASE}/${id}`,
      method: "PUT",
      data,
    });
...
export const customersService: ICustomersRepository =
