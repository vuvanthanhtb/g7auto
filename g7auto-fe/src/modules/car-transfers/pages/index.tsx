...
import { carTransferColumns, carTransfersFormConfig, carTransferSearchConfig } from "./car-transfers.config";
...
const CarTransfersPage = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <BaseFormComponent formConfig={carTransferSearchConfig} options={{ transferStatusOptions }} handlers={searchHandlers} />
      <BaseTableComponent
