...
import { BUTTON, DATETIME, SELECT, TEXT } from "@/libs/constants/form.constant";
import {
  NUMERICAL_ORDER,
  TBL_BUTTON,
  TBL_STRING,
...
export const getTestDriveColumns = (): BaseTableColumn[] => [
  ...
  {
    name: "startTime",
    label: "TEST_DRIVES_FIELD_START_TIME",
    type: TBL_STRING,
  ...
  {
    name: "endTime",
    label: "TEST_DRIVES_FIELD_END_TIME",
    type: TBL_STRING,
    formatter: formatDateTime,
    styleCell: { textAlign: "center" },
  },
...
export const getTestDrivesFormConfig = (): IBaseFormConfig => ({
  fields: [
    ...
    { type: TEXT, name: "notes", label: "CONTRACTS_FIELD_NOTES", size: 12 },
    {
      ...
      childs: [
        {
          title: "TEST_DRIVES_BTN_REGISTER",
          type: "submit",
          action: BTN_SUBMIT,
        },
      ],
...
export const getTestDrivesDetailFormConfig = (): IBaseFormConfig => ({
  fields: [
    { type: TEXT, name: "notes", label: "CONTRACTS_FIELD_NOTES", size: 12 },
    {
      ...
      childs: [
        {
          title: "TEST_DRIVES_BTN_CONFIRM",
          type: "button",
          action: BTN_CONFIRM,
          style: { background: "#1976d2", color: "#fff" },
        },
        {
          title: "TEST_DRIVES_BTN_COMPLETE",
          type: "button",
          action: BTN_COMPLETE,
          style: { background: "#2e7d32", color: "#fff" },
        },
        {
          title: "TEST_DRIVES_BTN_CANCEL",
          type: "button",
          action: BTN_CANCEL,
